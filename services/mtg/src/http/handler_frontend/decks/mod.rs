...
pub fn initialize_routes() -> GalvynRouter {
    GalvynRouter::new()
        // What the offered formats ask of a deck is the same answer for
        // everybody and says nothing about any account, and the public deck
        // search needs it to name the formats it filters by.
