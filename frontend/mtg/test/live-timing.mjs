...
// ../../node_modules/.pnpm/tesseract.js@5.1.1/node_modules/tesseract.js/src/worker/node/defaultOptions.js
var require_defaultOptions2 = __commonJS({
  "../../node_modules/.pnpm/tesseract.js@5.1.1/node_modules/tesseract.js/src/worker/node/defaultOptions.js"(exports, module) {
...
// ../../node_modules/.pnpm/tesseract.js@5.1.1/node_modules/tesseract.js/src/worker/node/spawnWorker.js
var require_spawnWorker = __commonJS({
  "../../node_modules/.pnpm/tesseract.js@5.1.1/node_modules/tesseract.js/src/worker/node/spawnWorker.js"(exports, module) {
    var { Worker } = __require("worker_threads");
    module.exports = ({ workerPath }) => new Worker(workerPath);
  }
});

// ../../node_modules/.pnpm/tesseract.js@5.1.1/node_modules/tesseract.js/src/worker/node/terminateWorker.js
var require_terminateWorker = __commonJS({
  "../../node_modules/.pnpm/tesseract.js@5.1.1/node_modules/tesseract.js/src/worker/node/terminateWorker.js"(exports, module) {
...
// ../../node_modules/.pnpm/tesseract.js@5.1.1/node_modules/tesseract.js/src/worker/node/onMessage.js
var require_onMessage = __commonJS({
  "../../node_modules/.pnpm/tesseract.js@5.1.1/node_modules/tesseract.js/src/worker/node/onMessage.js"(exports, module) {
...
// ../../node_modules/.pnpm/tesseract.js@5.1.1/node_modules/tesseract.js/src/worker/node/send.js
var require_send = __commonJS({
  "../../node_modules/.pnpm/tesseract.js@5.1.1/node_modules/tesseract.js/src/worker/node/send.js"(exports, module) {
...
var require_tr46 = __commonJS({
  "../../node_modules/.pnpm/tr46@0.0.3/node_modules/tr46/index.js"(exports, module) {
    ...
    module.exports.toASCII = function(domain_name, useSTD3, processing_option, verifyDnsLength) {
      ...
      if (verifyDnsLength) {
        var total2 = labels.slice(0, labels.length - 1).join(".").length;
        if (total2.length > 253 || total2.length === 0) {
          result.error = true;
        }
        for (var i = 0; i < labels.length; ++i) {
...
// ../../node_modules/.pnpm/tesseract.js@5.1.1/node_modules/tesseract.js/src/worker/node/loadImage.js
var require_loadImage = __commonJS({
  "../../node_modules/.pnpm/tesseract.js@5.1.1/node_modules/tesseract.js/src/worker/node/loadImage.js"(exports, module) {
...
// ../../node_modules/.pnpm/tesseract.js@5.1.1/node_modules/tesseract.js/src/worker/node/index.js
var require_node = __commonJS({
  "../../node_modules/.pnpm/tesseract.js@5.1.1/node_modules/tesseract.js/src/worker/node/index.js"(exports, module) {
      ...
      onMessage(worker, ({
        ...
        if (status === "resolve") {
          ...
          if (action === "recognize") {
            ...
            d = Array.from({ ...data2, length: Object.keys(data2).length });
          }
          resolves[promiseId]({ jobId, data: d });
        } else if (status === "reject") {
          rejects[promiseId](data2);
...
var assetRoot = () => `${self.location.origin}/tesseract`;
var pending2 = null;
function titleStrip(card, upsideDown) {
  ...
  const out = new ImageData(width2 * ENLARGE, height * ENLARGE);
...
function loadReader() {
  pending2 ??= (async () => {
    ...
    if (!probe?.ok) {
      throw new Error(`OCR-Dateien fehlen unter ${root} \u2014 "pnpm run ocr:assets" ausf\xFChren`);
    }
    const { createWorker } = await Promise.resolve().then(() => __toESM(require_src(), 1));
...
var NAMED_CANDIDATES = 6;
function envWorkingSize() {
  const configured = typeof process !== "undefined" ? Number(process.env?.LIVEWORK) : NaN;
  return Number.isFinite(configured) && configured > 0 ? configured : 720;
}
var LIVE_WORKING_SIZE = envWorkingSize();
var AGREEMENT_HITS = 2;
var EXPLORE_EVERY = 3;
var exploitable = (variant) => VARIANTS[variant].rotation === 0;
...
async function previewFrame(pixels2, index2, embedder2, variantIndex) {
  ...
  const timings = { detect: 0, embed: 0, search: 0, ocr: 0 };
  ...
  const projected = index2.project(vector);
  const bySight = index2.search(projected, LIVE_SHORTLIST);
  timings.search = performance.now() - searchStarted;
  const ocrStarted = performance.now();
  const title = await readName(crop);
  const byName = title ? index2.searchNamed(projected, title, NAMED_CANDIDATES) : [];
...
function createAgreementTracker() {
  ...
  return {
     ...
     */
    seen(id, score, named) {
      window2.push({ id, score, named });
      if (window2.length > AGREEMENT_WINDOW) window2.shift();
...
var labelFile = option("--labels", "");
var imagesDir = option("--images", "");
...
if (labelFile) {
  ...
  const labels = JSON.parse(await readFile2(labelFile, "utf8"));
  let correct = 0;
  let elapsed = 0;
  for (const label of labels) {
    const decoded = await sharp(join(imagesDir, label.file)).rotate().resize({ width }).ensureAlpha().raw().toBuffer({ resolveWithObject: true });
    const frame = {
...
`);
  ...
  process.stdout.write(
    `
${correct}/${labels.length} f\xFChrender Kandidat richtig, ${(elapsed / labels.length / 4).toFixed(0)} ms pro Frame
`
  );
  process.exit(0);
}
