    ...
    return (
        <Dialog open={open} onClose={onClose} size={"2xl"}>
            <DialogTitle className={"flex items-center gap-3"}>
                ...
                <Button plain onClick={onClose} aria-label={t("button.assumptions-done")} className={"-mr-2 shrink-0"}>
            ...
            <DialogBody>
                <div className={"flex flex-col gap-6"}>
                    <Section icon={ScaleIcon} title={t("heading.read-against")}>
                        ...
                        <div className={"mt-4"}>
                            {houseRules.length === 0 ? (
                                <p className={"flex items-center gap-1.5 text-xs/5 text-zinc-500 dark:text-zinc-400"}>
                                    <CheckCircleIcon
