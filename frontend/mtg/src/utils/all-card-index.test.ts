...
import { selectCandidateRoutes } from "./all-card-index";
import type { ImageSignature } from "src/types";
import type { RuntimeRoute } from "./all-card-index";
...
/**
 * Builds a routing entry with only the fields the shortlist selection looks at
 *
 * @param position
 * @param hash
 * @returns
