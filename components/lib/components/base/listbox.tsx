...
/**
 * The properties for {@link Listbox}
 */
...
/**
 * A custom styled select dropdown.
 *
 * @example
 * ```tsx
 ...
 * ```
 *
 * @see https://catalyst.tailwindui.com/docs/listbox
 */
export function Listbox<T>(props: ListboxProps<T>) {
    const { className, placeholder, autoFocus, "aria-label": ariaLabel, children: options, ...rest } = props;
    return (
        <Headless.Listbox {...rest} multiple={false}>
...
/**
 * The properties for {@link ListboxOption}
 */
export type ListboxOptionProps<T> = {
    /** Additional CSS classes */
    className?: string;
    /** The option content */
    children?: React.ReactNode;
...
/**
 * An option within a {@link Listbox}
 *
 * @see https://catalyst.tailwindui.com/docs/listbox
 */
export function ListboxOption<T>(props: ListboxOptionProps<T>) {
    ...
    return (
        <Headless.ListboxOption as={Fragment} {...rest}>
            {({ selectedOption }) => {
                if (selectedOption) {
...
/**
 * The text label of a {@link ListboxOption}
 */
export function ListboxLabel(props: React.ComponentPropsWithoutRef<"span">) {
    const { className, ...rest } = props;
    return <span {...rest} className={clsx(className, "ml-2.5 truncate first:ml-0 sm:ml-2 sm:first:ml-0")} />;
}

/**
 * A secondary description within a {@link ListboxOption}
 */
export function ListboxDescription(props: React.ComponentPropsWithoutRef<"span">) {
